...
## Corpus Check
- 32 files · ~26,401 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 202 nodes · 171 edges · 33 communities (21 shown, 12 thin omitted)
...
## Knowledge Gaps
- **140 isolated node(s):** `graphify`, `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)`, `Step 1 - Ensure graphify is installed` (+135 more)
...
- **Should `What You Must Do When Invoked` be split into smaller, more focused modules?**
  _Cohesion score 0.13333333333333333 - nodes in this community are weakly interconnected._
- **Should `1. Quick Start & Git Workflow (For Every Teammate & Agent)` be split into smaller, more focused modules?**
